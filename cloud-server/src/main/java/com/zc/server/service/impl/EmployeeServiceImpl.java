...
import com.zc.server.mapper.EmployeeMapper;
...
public class EmployeeServiceImpl extends ServiceImpl<EmployeeMapper, Employee> implements IEmployeeService {
    ...
    public RespBean addEmp(Employee employee) {
        ...
        if (employeeMapper.insert(employee) ==1){
            ...
            mailLog.setCount(MailConstants.DELIVERING);
    ...
    public ResPageBean getEmployeeWithSalary(Integer currentPage, Integer size) {
        ...
        ResPageBean resPageBean = new ResPageBean(iPage.getTotal(), iPage.getRecords());
        return resPageBean;
    }
}
